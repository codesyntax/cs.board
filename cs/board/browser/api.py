...
class BoardAPI(BrowserView):
    ...
    def generate_document(self, obj, document):
        ...
        try:
            ...
            log.info(obj.EffectiveDate())
            log.info(obj.ExpirationDate())
            doc_obj.setEffectiveDate(DateTime(obj.EffectiveDate()))
            doc_obj.setExpirationDate(DateTime(obj.ExpirationDate()))
            ...
            doc_obj_eu.setEffectiveDate(DateTime(obj.EffectiveDate()))
            doc_obj_eu.setExpirationDate(DateTime(obj.ExpirationDate()))
